...
### 🔗 Option 1: Share a Live Link

You can deploy your app **however you prefer**, as long as we can access it freely via the link.

We recommend using **Firebase Hosting** for Flutter web apps:  
...
### 🎥 Option 2: Share a Screen Recording
...
⚠️ **Note:**  
Public hackathon Wi-Fi may be limited if many people upload files at once.  
👉 Be mindful of your file size — compress if needed for faster upload.
